...
/**
 * Convocations Autoloader
 *
 * @class 		Convocations_Autoloader
 * @version		0.7
 * @package		Convocations/Classes/
 * @category	Class
 * @author 		JC
 */
class Convocations_Autoloader {
	...
	public function __construct() {
		...
		$this->include_path = untrailingslashit( plugin_dir_path( CONVOCATIONS_FILE ) ) . '/includes/';
	}
